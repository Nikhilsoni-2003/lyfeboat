...
const ExtraFieldRenderer = ({
  ...
  return (
    <div className="mb-3 animate-fade-in" style={{ marginLeft: `${marginLeft}px` }}>
...
export const AdditionalInfoCard = ({ extraFields }: AdditionalInfoCardProps) => {
  ...
  return (
    <Card className="p-6 bg-card border-border animate-fade-in">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-xl font-semibold text-card-foreground">Additional Information</h2>
